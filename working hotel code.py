...
def isNumber(question): #ensures input is a number
    while True:
        try:
            ...
            return i
            break
def roomReq(): #enquire how many rooms are needed and calculate total
...
#ensure date chosen is in the future
while d2>d1:
    print("Please pick a date in the future! ")
    getDate()
    isFuture() #resets variables
#enquire length of stay and ensure it is between 1 and 14 nights
